...
constructor(private id: number,private name: string ,private description: string,private images: string[],private codeURL: string,private demoURL: string,private type: ProjectType,private fields: Field[],private technologies: Technologie[],private idExperience: string){
...
public get _idExperience(): string {
    return this.idExperience;
}
public set _idExperience(value: string) {
